...
contract SimpleTokenCoin is MintableToken {
    ...
    string public constant name = "RV0 Coin";
...
contract Crowdsale is owned {
    ...
    */
    ...
    uint256 constant rate = 1000000000;
    ...
    function Crowdsale() public {
        ...
        phase = new CrowdsalePhase(1, 4500000000000, crowdsaleStart, 3 days, 30, rate, true);
    ...
    function isClosed() public returns (bool) {
        ...
        nextActivePhase();
        nextActivePhase();
        if (phase.number() == 3 && phase.saleIsOver()) {
            endTime = phase.getEndTime();
    ...
    function nextActivePhase() private {
        ...
        if (phase.number() == 1 && !isFailed()) {
            ...
            phase = new CrowdsalePhase(2, 10500000000000, phaseEnd, 1 days, 20, rate, false);
        }
            ...
            phase = new CrowdsalePhase(3, 15000000000000, phaseEnd, 1 days, 10, rate, false);
        }
